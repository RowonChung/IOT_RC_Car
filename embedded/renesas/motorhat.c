...
void change2MOT(){
    ...
    R_IIC_MASTER_SlaveAddressSet(&g_i2c_master0_ctrl, MOTOR_ADDR, I2C_MASTER_ADDR_MODE_7BIT);
...
void Left(){
    setPWM(0,0,250); // 값은 motor에 맞게 수정해야 한다.
}

void Right(){
    setPWM(0,0,550); // 값은 motor에 맞게 수정해야 한다.
}
